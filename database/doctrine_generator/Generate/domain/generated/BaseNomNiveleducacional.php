 ...
 */
abstract class BaseNomNiveleducacional extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_niveleducacional');
        $this->hasColumn('idniveleducacional', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_niveleducacional_seq',
             ));
