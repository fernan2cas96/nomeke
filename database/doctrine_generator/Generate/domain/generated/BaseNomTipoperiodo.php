 ...
 */
abstract class BaseNomTipoperiodo extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_tipoperiodo');
        $this->hasColumn('idtipoperiodo', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_fuerzatrabajo.sec_tipoperiodo_seq',
             ));
        ...
        $this->hasColumn('cantpedidos', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'notnull' => true,
