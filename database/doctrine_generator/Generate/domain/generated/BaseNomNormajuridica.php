 ...
 */
abstract class BaseNomNormajuridica extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_normajuridica');
        $this->hasColumn('idnormajuridica', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_estructuracomp.sec_normajuridica_seq',
             ));
