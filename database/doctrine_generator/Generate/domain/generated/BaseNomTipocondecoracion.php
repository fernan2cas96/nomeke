 ...
 */
abstract class BaseNomTipocondecoracion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_tipocondecoracion');
        $this->hasColumn('idtipocondecoracion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_tipocondecoracion_seq',
             ));
