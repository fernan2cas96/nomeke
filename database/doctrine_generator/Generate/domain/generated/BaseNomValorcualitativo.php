 ...
 */
abstract class BaseNomValorcualitativo extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_valorcualitativo');
        $this->hasColumn('idvalorcualitativo', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_rrhhmaestro.sec_valorcualitativo_seq',
             ));
