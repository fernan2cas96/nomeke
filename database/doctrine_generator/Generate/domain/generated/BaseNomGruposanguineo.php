 ...
 */
abstract class BaseNomGruposanguineo extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_gruposanguineo');
        $this->hasColumn('idgruposanguineo', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_persona.sec_gruposanguineo_seq',
             ));
        ...
        $this->hasColumn('compatiblecon', 'string', null, array(
             'type' => 'string',
             'fixed' => false,
             'unsigned' => false,
             'notnull' => false,
