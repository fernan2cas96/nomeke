...
/**
 * BaseNomTipocomponente
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property decimal $idtipocomponente
 * @property string $tipocomponente
...
abstract class BaseNomTipocomponente extends Doctrine_Record
{
    ...
    {
        $this->setTableName('nom_tipocomponente');
        $this->hasColumn('idtipocomponente', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_metadata.sec_tipocomponente_seq',
             ));
        $this->hasColumn('tipocomponente', 'string', null, array(
             'type' => 'string',
             'fixed' => false,
             'unsigned' => false,
             'notnull' => false,
