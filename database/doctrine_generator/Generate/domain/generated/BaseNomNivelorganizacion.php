 ...
 */
abstract class BaseNomNivelorganizacion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_nivelorganizacion');
        $this->hasColumn('idnivelorganizacion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_nivelorganizacion_seq',
             ));
