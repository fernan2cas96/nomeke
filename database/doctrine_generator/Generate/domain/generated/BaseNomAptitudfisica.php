 ...
 */
abstract class BaseNomAptitudfisica extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_aptitudfisica');
        $this->hasColumn('idaptitudfisica', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_aptitudfisica_seq',
             ));
