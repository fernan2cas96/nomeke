...
/**
 * BaseDatFamiliarresidente
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property decimal $idfamiliarresidente
 ...
 */
abstract class BaseDatFamiliarresidente extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('dat_familiarresidente');
        $this->hasColumn('idfamiliarresidente', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_familiarresidente_seq',
             ));
