...
/**
 * BaseNomCausalimitacion
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property decimal $idcausalimitacion
 ...
 */
abstract class BaseNomCausalimitacion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_causalimitacion');
        $this->hasColumn('idcausalimitacion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_causalimitacion_seq',
             ));
