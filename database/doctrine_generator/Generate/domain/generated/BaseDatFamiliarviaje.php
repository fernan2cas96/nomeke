...
/**
 * BaseDatFamiliarviaje
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property decimal $idfamiliarviaje
 ...
 */
abstract class BaseDatFamiliarviaje extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('dat_familiarviaje');
        $this->hasColumn('idfamiliarviaje', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_familiarviaje_seq',
             ));
