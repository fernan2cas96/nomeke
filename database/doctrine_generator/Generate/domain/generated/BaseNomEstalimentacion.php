 ...
 */
abstract class BaseNomEstalimentacion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_estalimentacion');
        $this->hasColumn('idestalimentacion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_estalimentacion_seq',
             ));
