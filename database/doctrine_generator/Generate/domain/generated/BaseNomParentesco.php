 ...
 */
abstract class BaseNomParentesco extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_parentesco');
        $this->hasColumn('idparentesco', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_parentesco_seq',
             ));
        ...
        $this->hasColumn('inverso', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'notnull' => false,
        ...
        $this->hasColumn('cant', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'notnull' => false,
