 ...
 */
abstract class BaseNomAsignaciondefensa extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_asignaciondefensa');
        $this->hasColumn('idasignaciondefensa', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_asignaciondefensa_seq',
             ));
