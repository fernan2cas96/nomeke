 ...
 */
abstract class BaseNomCargofacultado extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_cargofacultado');
        $this->hasColumn('idcargofacultado', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_estructuracomp.sec_cargofacultado_seq',
             ));
