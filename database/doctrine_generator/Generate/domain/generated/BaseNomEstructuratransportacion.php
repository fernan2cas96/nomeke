...
/**
 * BaseNomEstructuratransportacion
 * 
 ...
 * @property ModPersonaext.nomEstructuratransportacion $ModPersonaext.nomEstructuratransportacion
 * 
 * @package    ##PACKAGE##
 ...
 */
abstract class BaseNomEstructuratransportacion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_estructuratransportacion');
        $this->hasColumn('idestructuratransportacion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_estructuratransportacion_seq',
             ));
    ...
    {
        parent::setUp();
        $this->hasOne('ModPersonaext.nomEstructuratransportacion', array(
             'local' => 'idpadre',
             'foreign' => 'idestructuratransportacion'));
    }
}