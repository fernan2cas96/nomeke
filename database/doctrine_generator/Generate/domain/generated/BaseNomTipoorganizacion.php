 ...
 */
abstract class BaseNomTipoorganizacion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_tipoorganizacion');
        $this->hasColumn('idtipoorganizacion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_tipoorganizacion_seq',
             ));
