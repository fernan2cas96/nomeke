 ...
 */
abstract class BaseNomTipocentroestudio extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_tipocentroestudio');
        $this->hasColumn('idtipocentroestudio', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_tipocentroestudio_seq',
             ));
