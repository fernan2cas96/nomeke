 ...
 */
abstract class BaseNomCargoorganizacion extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_cargoorganizacion');
        $this->hasColumn('idcargoorganizacion', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_cargoorganizacion_seq',
             ));
