 ...
 */
abstract class BaseNomEstadovivienda extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_estadovivienda');
        $this->hasColumn('idestadovivienda', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_estadovivienda_seq',
             ));
