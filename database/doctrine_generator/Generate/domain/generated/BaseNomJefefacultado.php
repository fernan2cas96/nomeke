...
/**
 * BaseNomJefefacultado
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property decimal $idjefefacultado
 ...
 */
abstract class BaseNomJefefacultado extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_jefefacultado');
        $this->hasColumn('idjefefacultado', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_personaext.sec_jefefacultado_seq',
             ));
