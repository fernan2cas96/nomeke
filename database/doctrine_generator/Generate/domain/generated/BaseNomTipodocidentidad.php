 ...
 */
abstract class BaseNomTipodocidentidad extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('nom_tipodocidentidad');
        $this->hasColumn('idtipodocidentidad', 'decimal', null, array(
             'type' => 'decimal',
             'fixed' => false,
             'unsigned' => false,
             'primary' => true,
             'sequence' => 'mod_persona.sec_tipodocidentidad_seq',
             ));
